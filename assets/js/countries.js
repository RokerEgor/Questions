...
mayls.onclick = function () {
  mayls.classList.add("green");
  otvetsix.classList.remove("hidden");
};
max.onclick = function () {
  max.classList.add("red");
  mayls.classList.add("green");
  otvetsix.classList.remove("hidden");
};
...
forbtn.onclick = function () {
  forbtn.classList.add("red");
  fivebtn.classList.add("green");
...
vakanda.onclick = function () {
  almin.classList.add("green");
  vakanda.classList.add("red");
